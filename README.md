...
Si un dispenser no logra obtener un ingrediente de la orden porque el contenedor del mismo no tiene esa cantidad de ingrediente disponible, va a notificarle al thread que se encarga de su reposición y va a esperar hasta que se haya repuesto el ingrediente. Si el ingrediente no puede ser repuesto porque no hay recurso suficiente, la orden no se completa y los ingredientes de la misma que ya se hayan obtenido se van a descartar.
...
- Se disponen de 2 máquinas de café con 3 dispensers cada una.
- La cantidad inicial de ingredientes es 100.
- Los pedidos que se realizan son iguales con el objetivo de facilitar . En particular se utilizó el pedido: {"coffee": 10, "water": 10, "cocoa": 10, "foam": 10}, de manera que si una máquina realiza 10 pedidos, tiene que reponer ingredientes.
